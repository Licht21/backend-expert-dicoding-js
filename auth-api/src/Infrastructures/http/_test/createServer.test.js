...
describe('HTTP Server', () => {
    ...
    describe('when POST /users', () => {
        ...
        it('should response 400  when request payload not container needed property', async () => {
            // Arrange
            const requestPayload = {
                fullname: 'Dicoding Indonesia',
                password: 'secret'
        ...
        it('should response 400 when request payload not data type specification', async () => {
            // Arrange
            const requestPayload = {
                username: 'dicoding',
                password: 123,
